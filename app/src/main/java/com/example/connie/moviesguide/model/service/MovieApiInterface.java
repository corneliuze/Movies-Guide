...
public interface MovieApiInterface {
    ...
    retrofit2.Call<Result> getMovieDiscover();
    ...
    retrofit2.Call <Result> getSeriesDiscover();
    ...
    retrofit2.Call <Result> searchMovies(@Query("query") String movieTitle);

    //search tv
    @GET("3/search/tv?api_key=530409b67fad675e7ee11b7fb566d42e&language=en-US")
    retrofit2.Call <Result> searchTv(@Query("query") String tvSeries);
