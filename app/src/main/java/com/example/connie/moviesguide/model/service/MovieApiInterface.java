...
public interface MovieApiInterface {
    ...
    retrofit2.Call<MovieModel> getMovieDiscover();
    ...
    retrofit2.Call <MovieModel> getSeriesDiscover();
    ...
    retrofit2.Call <MovieModel> searchMovies(@Query("query") String movieTitle);

    //search tv
    @GET("3/search/tv?api_key=530409b67fad675e7ee11b7fb566d42e&language=en-US")
    retrofit2.Call <MovieModel> searchTv(@Query("query") String tvSeries);
