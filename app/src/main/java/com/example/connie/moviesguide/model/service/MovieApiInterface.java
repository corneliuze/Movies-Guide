...
public interface MovieApiInterface {
    ...
    //discover movie
    @GET("3/discover/movie?api_key=530409b67fad675e7ee11b7fb566d42&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false")
    retrofit2.Call<List<MovieModel>> getMovieDiscover();
    ...
    retrofit2.Call <List<MovieModel>> getSeriesDiscover();
    ...
    retrofit2.Call <List<MovieModel>> searchMovies(@Query("query") String movieTitle);

    //search tv
    @GET("3/search/tv?api_key=530409b67fad675e7ee11b7fb566d42e&language=en-US")
    retrofit2.Call <List<MovieModel>> searchTv(@Query("query") String tvSeries);
